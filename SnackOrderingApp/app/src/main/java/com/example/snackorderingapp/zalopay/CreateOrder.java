package com.example.snackorderingapp.zalopay;

import com.example.snackorderingapp.helper.ZaloHelpers;
...
public class CreateOrder {
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount) throws Exception {
            ...
            Amount = amount;
            AppTransId = ZaloHelpers.getAppTransId();
            EmbedData = "{}";
            Items = "[]";
            BankCode = "zalopayapp";
            Description = "Merchant pay for order #" + ZaloHelpers.getAppTransId();
            ...
            Mac = ZaloHelpers.getMac(AppInfo.MAC_KEY, inputHMac);
        }
    }
